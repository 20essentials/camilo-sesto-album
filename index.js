...
const nameBand = 'CAMILO SESTO';

let nameSongs = [
	"PERDÓNAME", /*1*/
	"ALGO DE MÍ", /*2*/
	"QUIERES SER MI AMANTE?", /*3*/
	"JAMÁS", /*4*/
	"CELOS ", /*5*/
	"AMOR... AMAR", /*6*/
	"SI ME DEJAS AHORA", /*7*/
	"VIVIR ASÍ ES MORIR DE AMOR", /*8*/
	"MELINA", /*9*/
	"DONDE ESTÉS, CON QUIEN ESTÉS", /*10*/
	" ALGO MÁS", /*11*/
	"EL AMOR DE MI VIDA", /*12*/
	"ENAMORATE DE MI", /*13*/
		"LA CULPA HA SIDO MIA", /*14*/
	"SOLO MIA", /*15*/
	"SOLO TÚ", /*16*/
	"MI BUEN AMOR", /*17*/
	"QUÉ DIFÍCIL ES SER FELIZ", /*18*/
	"ALMA DE NADIE", /*19*/
	"OLVÍDALO", /*20*/
]
